        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <button
            ...
            className="btn btn-sm btn-outline gap-2 transition-all
              ...
              [:root[data-theme=dark]_&]:hover:border-[#06b6d4] [:root[data-theme=dark]_&]:hover:text-[#06b6d4] [:root[data-theme=dark]_&]:hover:bg-transparent"
          >
            <ArrowPathIcon
              ...
              return (
                <article
                  ...
                  className="
                    ...
                    [:root[data-theme=dark]_&]:hover:shadow-cyan-900/20 [:root[data-theme=dark]_&]:hover:border-[#06b6d4]/50
                  "
                >
                  {/* 배너 이미지 */}
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="text-xl font-bold mb-3 line-clamp-2 transition-colors text-gray-900 group-hover:text-[#06b6d4] [:root[data-theme=dark]_&]:text-white [:root[data-theme=dark]_&]:group-hover:text-[#06b6d4]">
                      {item.title}
                    </h3>
              ...
              {loadingDetail ? (
                ...
                <div>
                  ...
                  <div className="p-6 md:p-8 space-y-6">
                    ...
                    <div
                      className="prose max-w-none text-gray-600 prose-headings:text-gray-900 prose-strong:text-gray-900 prose-a:text-[#06b6d4] [:root[data-theme=dark]_&]:prose-invert [:root[data-theme=dark]_&]:text-gray-300"
