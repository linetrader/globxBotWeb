...
export function QuantyView() {
  ...
  // Quanty 네임스페이스 사용
  const t = useTranslations("authLogin.Quanty");
  ...
  return (
    <div className="relative w-full min-h-[calc(100dvh-4rem)] flex items-center justify-center lg:justify-end bg-white [:root[data-theme=dark]_&]:bg-black transition-colors duration-300">
      <div className="absolute inset-0 z-0 overflow-hidden hidden lg:block">
        {/* Quanty 배경 이미지 */}
        <Image
          src="/Quantyloginbackground.jpg"
          alt="Quanty Login Background"
          fill
      ...
      <div className="relative z-10 w-full max-w-[420px] px-4 py-10 lg:mr-32 animate-in fade-in zoom-in duration-500">
        {/* [수정] bg-black/40 -> bg-black/70 (더 진하게 변경) */}
        <div className="w-full rounded-2xl p-6 md:p-8 shadow-2xl backdrop-blur-md transition-colors duration-300 bg-white border border-gray-200 [:root[data-theme=dark]_&]:bg-black/70 [:root[data-theme=dark]_&]:border-white/10">
